# 0x02-shell_redirections and filters<br/>
...
**7-file** - Write a shell script that creates a file named exactly files with backlash containing the text Best School ending by a new line.<br/><br/>
